...
public class GridLayoutAutofitManager extends GridLayoutManager {
    ...
    public GridLayoutAutofitManager(final Context context, final int columnWidth) {
    ...
    @Override
    public void onLayoutChildren(@NonNull RecyclerView.Recycler recycler, @NonNull final RecyclerView.State state) {
